        ...
        <Reveal delay={0.05}>
          <Panel padding="lg" className="mt-10">
            ...
            <Section title="Who we share it with">
              ...
              <ul className="list-disc space-y-1.5 pl-5">
                <li><span className="font-semibold text-ink">Vercel</span> — hosting, analytics and our Postgres database (via Neon).</li>
                <li><span className="font-semibold text-ink">Formspree</span> — processes quote-request form submissions.</li>
              </ul>
