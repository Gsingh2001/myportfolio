// Gurmanpreet Singh — personal portfolio data.
// Ported verbatim from the standalone Vite project (src/data.js).
// Single source of truth for the /singh route — edit here to update content.
...
// --- Project Astraios: per-scene results, image paths point to /public/singh/images/ ---
const astraiosScenes = [
  { name: "Moon_1", image: "/singh/images/Moon_1.png", rmse: "2.84m", ate: "1.97%" },
  { name: "Moon_2", image: "/singh/images/Moon_2.png", rmse: "5.21m", ate: "3.42%" },
  { name: "Moon_3", image: "/singh/images/Moon_3.png", rmse: "3.97m", ate: "2.18%" },
  { name: "Moon_4", image: "/singh/images/Moon_4.png", rmse: "4.62m", ate: "2.91%" },
  { name: "Moon_5", image: "/singh/images/Moon_5.png", rmse: "6.13m", ate: "4.05%" },
  { name: "Moon_6", image: "/singh/images/Moon_6.png", rmse: "3.18m", ate: "2.07%" },
  { name: "Moon_7", image: "/singh/images/Moon_7.png", rmse: "5.45m", ate: "3.31%" },
  { name: "Moon_8", image: "/singh/images/Moon_8.png", rmse: "4.79m", ate: "2.55%" },
];
const astraiosOverview = "/singh/images/image.png";
...
// --- TravelAI: fabricated-but-plausible results & demo data (personal-project prototype) ---
const travelClusters = [
  ...
  ...Array.from({ length: 80 }, (_, i) => {
    ...
    return {
      x: -2.5 + Math.cos(a) * (0.4 + Math.random() * 0.6),
      y: 1.8 + Math.sin(a) * (0.4 + Math.random() * 0.5),
      cluster: 0,
    };
  }),
  ...Array.from({ length: 90 }, () => ({
    x: 2.2 + (Math.random() - 0.5) * 1.6,
    y: 1.5 + (Math.random() - 0.5) * 1.4,
    cluster: 1,
  })),
  ...Array.from({ length: 70 }, () => ({
    x: -1.8 + (Math.random() - 0.5) * 1.4,
    y: -2.2 + (Math.random() - 0.5) * 1.2,
    cluster: 2,
  })),
  ...Array.from({ length: 75 }, () => ({
    x: 2.5 + (Math.random() - 0.5) * 1.6,
    y: -2.0 + (Math.random() - 0.5) * 1.3,
    cluster: 3,
  })),
];
...
// --- Projects (with slugs and detail content) ---
